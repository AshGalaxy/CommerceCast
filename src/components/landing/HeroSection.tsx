    ...
    <section className="relative w-full flex flex-col items-center pt-28 pb-10 overflow-hidden min-h-[110svh]">
      ...
      >
        ...
        <motion.div
          ...
          className="mt-16 w-full max-w-5xl relative z-20"
        >
          {/* Edge glow - restored original premium intense glow */}
          ...
          <div className="relative w-full rounded-t-[20px] border border-border/60 bg-background/60 backdrop-blur-3xl shadow-2xl overflow-hidden flex flex-col h-[450px] sm:h-[550px]"
          ...
          >
            {/* Top Bar - restored original vivid Mac buttons */}
            <div className="w-full h-12 border-b border-border/40 flex items-center px-4 gap-2 bg-muted/30">
